        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-block">
                    ...
                    @endif
                    <form action="admin/quanly/sua/{{ $admin->idadmin }}" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                    
                    <div class="form-group">
                        <label class="text-info">Tên</label>
                        <input name="ten" class="form-control" placeholder="Điền tên người dùng" value="{{ $admin->ten }}"></input>
                    </div>
                    <div class="form-group">
                        <label class="text-info">Email</label>
                        <input type="email" name="email" class="form-control" placeholder="Nhập địa chỉ Email" value="{{ $admin->email }}" readonly=""></input>
                    </div>
                    <div class="form-group">
